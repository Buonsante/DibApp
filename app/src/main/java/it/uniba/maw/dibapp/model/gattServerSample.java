...
//
//public class gattServerSample extends Activity {
//    private static final String TAG = gattServerSample.class.getSimpleName();
//
//    /* Local UI */
...
//        setContentView(R.layout.activity_gatt_server_sample);
//
...
//                    adjustReason = ServerProfile.ADJUST_MANUAL;
//                    break;
//                case Intent.ACTION_TIMEZONE_CHANGED:
//                    adjustReason = ServerProfile.ADJUST_TIMEZONE;
//                    break;
//                default:
//                case Intent.ACTION_TIME_TICK:
//                    adjustReason = ServerProfile.ADJUST_NONE;
//                    break;
//            }
...
//            return;
//        }
//        byte[] exactTime = ServerProfile.getExactTime(timestamp, adjustReason);
//
//        Log.i(TAG, "Sending update to " + mRegisteredDevices.size() + " subscribers");
//        for (BluetoothDevice device : mRegisteredDevices) {
//            BluetoothGattCharacteristic timeCharacteristic = mBluetoothGattServer
//                    .getService(ServerProfile.SERVER_SERVICE)
//                    .getCharacteristic(ServerProfile.CURRENT_TIME);
...
//            long now = System.currentTimeMillis();
//            if (ServerProfile.CURRENT_TIME.equals(characteristic.getUuid())) {
//                Log.i(TAG, "Read CurrentTime");
//                mBluetoothGattServer.sendResponse(device,
//                        requestId,
//                        BluetoothGatt.GATT_SUCCESS,
//                        0,
//                        ServerProfile.getExactTime(now, ServerProfile.ADJUST_NONE));
//            } else if (ServerProfile.LOCAL_TIME_INFO.equals(characteristic.getUuid())) {
//                Log.i(TAG, "Read LocalTimeInfo");
//                mBluetoothGattServer.sendResponse(device,
//                        requestId,
//                        BluetoothGatt.GATT_SUCCESS,
//                        0,
//                        ServerProfile.getLocalTimeInfo(now));
//            } else {
...
//            if (ServerProfile.CLIENT_CONFIG.equals(descriptor.getUuid())) {
